...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "f36949a1-7384-49c3-b1a8-614856ed2b5f");
  ...
  return (
    ...
    id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('../public/footer-bg-color.png')] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none">
      ...
      onSubmit={onSubmit} className="max-w-2xl mx-auto">
        ...
        >
          Submit now <Image src={assets.right_arrow_white} alt="rightarrow" className="w-4" />
        </motion.button>
